 ...
 * 100 requests per minute, keyed by tenant ID (falls back to IP).
 */
 ...
 * 200 requests per minute, keyed by tenant ID (falls back to IP).
 */
 ...
 * 50 requests per minute, keyed by tenant ID (falls back to IP).
 */
 ...
 * Runs before auth, so uses IP-based keying.
 */
